...
Revision ID: 337e9a8c0c79
Revises: 
Create Date: 2025-03-07 13:16:27.442489
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('symptoms', sa.String(), nullable=False),
    sa.Column('recommended_specialty', sa.String(), nullable=False),
    sa.Column('confirmed_specialty', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('complaint_id', sa.Integer(), nullable=False),
    sa.Column('recommended_doctor_specialty', sa.String(), nullable=False),
    sa.Column('recommendation_text', sa.String(), nullable=False),
    sa.Column('appointment_offered', sa.BOOLEAN(), nullable=True),
