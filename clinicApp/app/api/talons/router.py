...
from clinicApp.app.api.talons.schema import AppointmentResponseDoctor, AvailableSlotsResponse, AppointmentCreate, \
    DoctorAppointmentsResponse, AppointmentResponse
